...
/** 后台用户角色管理 */
@RestController
@Tag(name = "AdminRoleController", description = "后台用户角色管理")
...
public class AdminRoleController {
  ...
  public CommonResult<Integer> create(@RequestBody @Validated AdminRole role) {
  ...
  public CommonResult<Integer> update(
      @PathVariable Integer id, @RequestBody @Validated AdminRole role) {
